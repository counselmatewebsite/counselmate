/**
 * Register Page - Client/Apprentice Registration
 */
...
export default function RegisterPage() {
  ...
  // If user is trying to register as professional, redirect them
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (data.auth_url) {
        // Store that we want a client role after Google redirect
        sessionStorage.setItem('pendingRole', 'APPRENTICE');
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-4 border-t border-slate-200">
              <p className="text-sm text-slate-600 mb-4">
                Are you a professional? Register with your credentials.
              </p>
